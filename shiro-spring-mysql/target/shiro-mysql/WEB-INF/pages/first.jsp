			...
			<header class="navbar front-end-navbar" data-spy="affix" data-offset-top="1">
			  <div class="container">
			    <div class="navbar-header">
			      ...
			      <a href="../index.html" class="navbar-brand"><strong><span class="text-success">CAS</span>APPLICATION</strong></a>
			    </div>
			   ...
			   <!--     <li>
			      ...
			      <ul class="nav navbar-nav navbar-right">
			        <li class="btn-link"><a href="${contextPath}/toLogin" class="btn btn-sm btn-success">Login</a></li>
			        <li class="btn-link"><a href="${contextPath}/userAdd" class="btn btn-sm btn-purple">Register</a></li>
			      </ul>
			    </nav>
			  </div>
			</header>
